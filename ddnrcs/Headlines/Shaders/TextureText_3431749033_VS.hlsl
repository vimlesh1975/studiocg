...
output.WorldTexturePos = mul(input.Position, WorldTexture);
output.WorldTextureUV = mul(float4(input.TexCoord.x, input.TexCoord.y, 1.0f, 1.0f), WorldTexture);
output.WorldTexturePosKey = mul(input.Position, WorldTextureKey);
output.WorldTextureUVKey = mul(float4(input.TexCoord.x, input.TexCoord.y, 1.0f, 1.0f), WorldTextureKey);
