...
output.Reflection = reflect(worldPosition.xyz - Eye, output.Normal);
output.Reflection.y = -output.Reflection.y;
output.Reflection = mul(float4(output.Reflection.x, output.Reflection.y, output.Reflection.z, 1.0f), WorldTextureReflectionMap);
return output;
}
